      ...
      groups: [
        {
          ...
          items: createItems("special-terms", "terms", [
            ...
            {
              label:
                "임대인은 임차인의 전세보증금 반환보증 가입에 적극 협조한다. 임대인 또는 임차 목적물(주택)의 하자로 인한 반환보증 가입 미승인 시, 계약은 무효로 하며 임대인은 계약금, 중도금, 잔금 등 임차인에게 지급받은 금액 전액을 즉시 반환한다.",
            },
            {
              label:
            ...
            {
              label:
                "임차인의 귀책사유가 없는 주택과 시설물의 고장(노후로 인한 고장)은 임대인이 적극 수리하기로 한다.",
            },
          ]),
        },
      ],
